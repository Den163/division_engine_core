...
DIVISION_EXPORT void division_engine_texture_free(DivisionContext* ctx, uint32_t texture_id);

DIVISION_EXPORT void division_engine_texture_set_data(DivisionContext* ctx, uint32_t texture_id, void* data);
